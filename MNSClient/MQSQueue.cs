...
namespace AMQS
{
    public class MQSQueue
    {
        ...
        {
            return client.execute<MessageSendResponse>(MQSClient.Method.POST, string.Format("/queues/{0}/{1}", name, "messages"),
                new Dictionary<string, string>(),
        ...
        {
            client.executeAsync(MQSClient.Method.GET, string.Format("/queues/{0}/{1}", name, "messages"),
